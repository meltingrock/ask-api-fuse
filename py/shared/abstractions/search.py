...
class GraphEntityResult(FUSESerializable):
    name: str
    description: str
...
class GraphRelationshipResult(FUSESerializable):
    # name: str
    subject: str
    predicate: str
    object: str
...
class GraphCommunityResult(FUSESerializable):
    name: str
    summary: str
    rating: float
...
class ContextDocumentResult(FUSESerializable):
    """
